...
def store_to_db(fullname,email,username,password,mobile,aadhar,location):
    ref = db.reference('credentials/Customer')
...
with st.container(border=True):
    ...
    if st.button("Sign Up"):
        ...
        if fullname and email and username and password and mobile and aadhar and location:
            save = store_to_db(fullname,email,username,password,mobile,aadhar,location)
            if ok and not save:
